...
namespace Test.Scratch
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var database = new PetaPoco.Database(CONSTANTS.SongsConnectionStringName);
            var songs = new List<Song> { 
                    new Song{ Title = "Take a Walk", Length = "4:24", TrackNumber = 1 },
                    new Song{ Title = "I'll Be Alright", Length = "4:22", TrackNumber = 2 },
                    new Song{ Title = "Carried Away", Length = "3:42", TrackNumber = 3 },
                    new Song{ Title = "Constant Conversations", Length = "3:56", TrackNumber = 4},
                    new Song{ Title = "Mirrored Sea", Length = "4:06", TrackNumber = 5 },
                    new Song{ Title = "Cry Like A Ghost", Length = "4:23", TrackNumber = 6 },
                    new Song{ Title = "On My Way", Length = "3:47", TrackNumber = 7},
                    new Song{ Title = "Hideaway", Length = "3:51", TrackNumber = 8},
                    new Song{ Title = "Two Veils to Hide My Face", Length = "0:34", TrackNumber = 9},
                    new Song{ Title = "Love Is Greed", Length = "4:20", TrackNumber = 10},
                    new Song{ Title = "It's Not My Fault, I'm Happy", Length = "5:06", TrackNumber = 11},
                    new Song{ Title = "Where We Belong", Length = "5:00", TrackNumber = 12},
                };
            foreach (var song in songs)
            {
                song.AlbumId = 4;
                song.Genre = "Indietronic";
            }
        }
